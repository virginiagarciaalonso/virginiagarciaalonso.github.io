...
In addition to marine science and open science, I got hooked on the world of [data visualisation]{.bold}, and then [visualisations in general]{.bold}. Being creative and thinking of ways to design effective and engaging visualisations has become another important feature of the projects I do. You can find some of the projects I've been involved at this [Viz Gallery](viz.qmd).
...
![](images/favicon.png){fig-align="center" width="35%" fig-alt="Three splashes of paint overlapping with each other at the centre. One yellow, another blue, and the third one green."}

It has paint splashes (my artistic input 🎨) in three colors: 

-  [blue]{.bold .blue-text} for my love for marine sciences 
-  [yellow]{.bold .yellow-text} portraying the positiive impact from communites of practice 
